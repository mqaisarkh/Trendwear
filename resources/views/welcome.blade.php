...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Your Brand Name - Premium Fashion</title>
        ...
        <div class="relative h-screen">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="text-center text-white">
                    ...
                    <a href="#" class="bg-white text-black px-8 py-3 rounded-full text-lg font-medium hover:bg-gray-100 transition duration-300">
                        Shop Now
                    </a>
                </div>
            </div>
